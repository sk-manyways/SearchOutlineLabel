...
func TestTrie_addLineBasic1(t *testing.T) {
	trie := NewTrie(5)
	trie.addLine("hello There", createDummyFileInfo(), 20)
	trie.addLine("there are apples", createDummyFileInfo(), 21)
...
func TestTrie_addLineUnderscore1(t *testing.T) {
	trie := NewTrie(5)
	trie.addLine("hello There a_request, 123", createDummyFileInfo(), 20)
	trie.addLine("there are apples", createDummyFileInfo(), 21)
...
func TestTrie_addLineNumbers1(t *testing.T) {
	trie := NewTrie(2)
	trie.addLine("hello There a_request, 123", createDummyFileInfo(), 20)
	trie.addLine("there are apples 12, z1", createDummyFileInfo(), 21)
